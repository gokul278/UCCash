  ...
  <div class="block-31" style="position: relative;">
    <div class="owl-carousel loop-block-31 ">
      <div class="block-30 block-30-sm item"
        style="background-image: url(./images/log.jpg);background-size: cover;width: 100%;"
        ...
        <div class="col-md-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Your small contribution will go a long way in fulfilling our mission. Help us create a cleaner
                environment and create a hunger-free society and participate in this great act of nature conservation.
              </p>
        ...
        <div class="col-md-4">
          <div class="media block-6">
            ...
            <div class="media-body">
              ...
              <p>Our foundation needs socially conscious volunteers. Let's build a healthy, natural, hunger-free society
                in this world.</p>
          ...
          <div class="form-volunteer">
            ...
            <form id="volunteerfrm">
              ...
              <div class="form-group">
                ...
                <textarea id="message" cols="30" rows="3" name="message" class="form-control py-2"
...
<script type="application/ld+json">
    {
      ...
      "@type" : "WebSite",
      "name" : "UCCash Foundation - Home",
      "url" : "https://www.uccashfoundation.com/"
    }
  </script>
