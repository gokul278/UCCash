      ...
      <div class="col-md-6 pl-md-6">
          ...
          <form id="form1">
            <div class="form-volunteer1">
              <div class="form-group">
                <input type="text" class="form-control py-2" id="name" name="name" placeholder="Enter your name *"
                  required>
              </div>
              <div class="form-group">
                <input type="tel" class="form-control py-2" id="phoneno" name="phoneno"
                  placeholder="Enter your contact number *" pattern="[7-9]{1}[0-9]{9}" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="panno" name="panno" placeholder="Enter your PAN number"
              ...
              <div class="form-group">
                <input type="text" class="form-control py-2" id="address1" name="address1"
                  placeholder="Enter your address-1 *" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="address2" name="address2"
                  placeholder="Enter your address line-2">
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="city" name="address"
                  placeholder="Enter your City / Town *" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="district" name="address"
                  placeholder="Enter your District *" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="state" name="address" placeholder="Enter your State *"
                  required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="zipcode" name="address"
                  placeholder="Enter your Zip / Postal code *" pattern="^(?:[0-9]\d{0,10}|100000)$" required>
              </div>
              <div class="form-group">
                <input type="text" class="form-control py-2" id="country" name="address"
                  placeholder="Enter your Country *" required>
              </div>
              <div class="form-group">
                <input type="tel" class="form-control py-2" id="amount" name="amount" placeholder="Enter your amount *"
                  pattern="^(?:[1-9]\d{0,4}|100000)$" required>
              </div>
        ...
        <form id="form2">
          <div class="form-volunteer2">
            ...
            <p><strong>EMAIL ADDRESS : <a
                  href="mailto:uccashfoundation@gmail.com">uccashfoundation@gmail.com</a></strong></p>
            <br><br>
            <p style="color:#DAA520;"><b>Note : Upload your payment successful screenshot here</b>&nbsp;&nbsp;<b
                style="color:red">( File Size in below 1MB )</b></p>
...
<p style="text-align: center;color: white;" class="footer-company-name"><b>Copyright ©2023 UCCASH Foundation| All rights
    reserved</b></p>
<!-- loader -->
<!-- loader -->
...
<script type="application/ld+json">
    {
      ...
      "@type" : "WebSite",
      "name" : "UCCash Foundation - Donate",
      "url" : "https://www.uccashfoundation.com/donate"
    }
  </script>
